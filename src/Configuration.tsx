            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-amber-200 text-xs">
                  Modifying control definitions will mark them as "Revised" and
                  create an audit trail. Ensure changes align with CMMC
              ...
              <div className="p-6 border-b border-zinc-700">
                <div className="flex items-start justify-between">
                  ...
                  <div className="flex gap-2">
                    ...
                    >
                      {expandedControl === control._id ? "Collapse" : "Expand"}
                    </button>
                  </div>
                </div>
              </div>
                          ...
                          <div className="bg-purple-900/30 p-4 rounded-lg border border-purple-700">
                            ...
                            {control.revisionNotes && (
                              <div className="text-sm text-purple-300">
                                <strong>Notes:</strong> {control.revisionNotes}
                              </div>
                            )}
                          </div>
                        </div>
